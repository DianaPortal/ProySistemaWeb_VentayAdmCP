...
namespace SistemaVenta.BLL.Servicios
{
    public class DashBoardService : IDashBoardService
    {
        ...
        //Obtener el Total de las ventas de la última semana
        ...
        //Obtener el Total de ingresos de la Ultima semana
        ...
        //Obtener el total de Stock de los productos
        ...
        //Obtener la cantidad de ventas realizadas la ultima semana
        ...
        public async Task<DashBoardDTO> Resumen()
        {
            ...
            try
            {
                ...
                // Inicializa la propiedad con la lista de ventas
                vmDashBoard.VentasUltimaSemana = new List<VentasSemanaDTO>();

                foreach (KeyValuePair<string, int> item in await VentasUltimaSemana())
                {
                    vmDashBoard.VentasUltimaSemana.Add(new VentasSemanaDTO()
                    {
                        Fecha = item.Key,
                        Total = item.Value
                    });
